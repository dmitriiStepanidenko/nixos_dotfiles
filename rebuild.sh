...
sudo nixos-rebuild switch -I nixos-config=/home/dmitrii/shared/dotfiles/etc/nixos/configuration.nix --flake /home/dmitrii/shared/dotfiles/etc/nixos/flake.nix &>nixos-switch.log || (cat nixos-switch.log | grep --color error && exit 1)
