...
in
  stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-VGdv0A++npVcodTeXOO0HxGXc7QuEEhTtQ7BFXColj4=";
    };

    cargoDeps = rustPlatform.fetchCargoVendor {
      inherit (finalAttrs) src cargoRoot;
      hash = "sha256-HIGiWTMfE6v1K3hayl0XTIEcO1ATOJd31AQ0eGTIjxs=";
    };
    ...
    node_modules = stdenv.mkDerivation {
      ...
      outputHash =
        {
          #x86_64-linux = "sha256-5At2Nrcj7fTmjO2xyJQrkKm1O4a+clNQYSGQZ+ibkbs=";
