...
# and in the NixOS manual (accessible by running ‘nixos-help’).
{
  ...
  environment.systemPackages = with pkgs; [
    inputs.nixpkgsunstable.legacyPackages.${pkgs.system}.vim # Do not forget to add an editor to edit configuration.nix! The Nano editor is also installed by default.
    vim
    wget
    neovim
    displaylink
